          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm space-y-1">
              ...
              <ul className="text-muted-foreground space-y-1 mr-4">
                ...
                <li>• المديرون الفرعيون يمكنهم استرجاع إقراراتهم فقط</li>
                <li>• المدير العام يمكنه استرجاع أو حذف جميع الإقرارات</li>
              </ul>
            </div>
          </div>
        </Card>
                ...
                declarations.map((declaration) => {
                  ...
                  return (
                    <TableRow key={declaration.id} className="hover:bg-muted/5">
                      ...
                      <TableCell>
                        {new Date(declaration.deleted_at).toLocaleDateString('ar-SA')}
                      </TableCell>
                      <TableCell>
                        <Badge 
                          variant="outline"
