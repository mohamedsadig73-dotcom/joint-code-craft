...
import { Warehouse, Package, UserCheck, MapPin, ClipboardList, AlertTriangle, ListChecks } from 'lucide-react';
...
export default function Inventory() {
  ...
  // Keep URL synced for deep-linking & back-compat redirects.
  useEffect(() => {
