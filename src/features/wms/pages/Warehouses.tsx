...
interface Row { id: string; code: string; name_ar: string; name_en: string | null; is_active: boolean; }
export default function Page() {
  ...
  return <GenericListPage<Row> table="warehouses" titleKey="wms.nav.warehouses"
