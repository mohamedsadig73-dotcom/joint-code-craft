...
export const SmartNudge = memo(function SmartNudge({ nudge, onDismiss, className }: SmartNudgeProps) {
  ...
  return (
    <div
      className={cn(
        'relative flex items-center gap-3 p-4 rounded-lg border animate-slide-up',
        style.bg,
        className
      )}
