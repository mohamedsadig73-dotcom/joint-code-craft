...
const translations = {
  en: {
    ...
    wmsReports: 'Reports',
    wmsAdvancedReports: 'Advanced KPI',
    wmsWorkerProductivity: 'Worker Productivity',
    wmsPredictiveAnalytics: 'Predictive Analytics',
    wmsCustomers: 'Customers',
    wmsCustomerPortal: 'Customer Portal',
    wmsAlerts: 'Alerts',
    ...
    // New WMS Features
    wms3PLTenants: '3PL Tenants',
    wmsBilling: 'Billing',
    wmsEcommerce: 'E-commerce',
    wmsTemperatureZones: 'Temperature Zones',
    wmsMES: 'MES / WIP',
    wmsCompliance: 'Compliance',
    ...
    warning: 'Warning',
    critical: 'Critical',
    mesIntegration: 'MES Integration',
    wipManagement: 'WIP Management',
  ...
  ar: {
    ...
    wmsReports: 'التقارير',
    wmsAdvancedReports: 'تقارير KPI المتقدمة',
    wmsWorkerProductivity: 'إنتاجية العمال',
    wmsPredictiveAnalytics: 'التحليلات التنبؤية',
    wmsCustomers: 'العملاء',
    wmsCustomerPortal: 'بوابة العملاء',
    wmsAlerts: 'التنبيهات',
    ...
    // New WMS Features
    wms3PLTenants: 'إدارة المستأجرين (3PL)',
    wmsBilling: 'الفوترة',
    wmsEcommerce: 'التجارة الإلكترونية',
    wmsTemperatureZones: 'مناطق الحرارة',
    wmsMES: 'تكامل MES / WIP',
    wmsCompliance: 'الامتثال للوائح',
    tenantsManagement: 'إدارة المستأجرين',
    tenantName: 'اسم المستأجر',
    tenantCode: 'رمز المستأجر',
    contractStart: 'بداية العقد',
    contractEnd: 'نهاية العقد',
    storageAllocation: 'مساحة التخزين',
    ...
    tenantDeleted: 'تم حذف المستأجر بنجاح',
    ...
    temperatureMonitoring: 'مراقبة الحرارة',
    zoneName: 'اسم المنطقة',
    targetTemp: 'الحرارة المستهدفة',
    currentTemp: 'الحرارة الحالية',
    tempStatus: 'الحالة',
    normal: 'طبيعي',
    warningStatus: 'تحذير',
    criticalStatus: 'حرج',
    mesIntegration: 'تكامل MES',
    wipManagement: 'إدارة الأعمال تحت التنفيذ',
    workOrder: 'أمر العمل',
