...
const translations = {
  ...
  ar: {
    ...
    locationLabel: 'ملصق الموقع',
    itemLabel: 'ملصق الصنف',
    printerType: 'نوع الطابعة',
    selectPrinter: 'اختر الطابعة',
    thermal58mm: 'حرارية 58 مم',
    thermal80mm: 'حرارية 80 مم',
    a4Laser: 'طابعة ليزر A4',
    copies: 'النسخ',
    copy: 'نسخة',
    ...
    reprintLast: 'إعادة طباعة الأخير',
