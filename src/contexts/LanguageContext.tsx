...
const translations = {
  en: {
    ...
    leaveRequestsSubtitle: 'Manage annual leave requests and balance calculations',
    ...
    leaveReason: 'Reason',
    enterLeaveReason: 'Enter leave reason (optional)',
    ...
    leaveRequestCreationFailed: 'Failed to create leave request',
    totalRequests: 'Total Requests',
    pendingRequests: 'Pending Requests',
    approvedRequests: 'Approved Requests',
    rejectedRequests: 'Rejected Requests',
    allLeaveRequests: 'All Leave Requests',
    allLeaveRequestsDescription: 'View and manage all annual leave requests',
    noLeaveRequests: 'No leave requests',
    noLeaveRequestsDescription: 'Create your first leave request to get started',
  ...
  ar: {
    ...
    leaveRequestsSubtitle: 'إدارة طلبات الإجازة السنوية وحساب الأرصدة',
    newLeaveRequest: 'طلب إجازة جديد',
    annualLeaveRequestForm: 'نموذج طلب الإجازة السنوية',
    ...
    previouslyUsedDays: 'الأيام المستهلكة سابقاً',
    ...
    enterLeaveReason: 'أدخل سبب الإجازة (اختياري)',
    deputyInformation: 'بيانات النائب/البديل',
    deputyName: 'اسم النائب',
    deputyDepartment: 'إدارة النائب',
    deputyContact: 'رقم تواصل النائب',
    importantNotice: 'تنبيه هام',
    leaveWarningMessage: 'لا تُمنح الإجازة السنوية إلا بعد اجتياز 6 أشهر من تاريخ التعيين، ويُشترط ألا يقل الرصيد المتبقي عن 5 أيام بعد خصم المدة المطلوبة.',
    submitRequest: 'تقديم الطلب',
    leaveRequestCreated: 'تم إنشاء طلب الإجازة بنجاح',
    leaveRequestCreationFailed: 'فشل إنشاء طلب الإجازة',
    ...
    allLeaveRequestsDescription: 'عرض وإدارة جميع طلبات الإجازة السنوية',
    noLeaveRequests: 'لا توجد طلبات إجازة',
    noLeaveRequestsDescription: 'أنشئ أول طلب إجازة للبدء',
    remainingBalance: 'الرصيد المتبقي',
    rejectedLessThan6Months: 'مرفوض - لم يتم 6 أشهر',
    rejectedInsufficientBalance: 'مرفوض - نقص رصيد',
  },
};
